...
public class ZombieBossOriginal extends Boss implements Listener {
    ...
    public ZombieBossOriginal(PluginMain pl, Location l) {
        this.pl = pl;
        this.undead = l.getWorld().spawn(l, Zombie.class, zombie -> {
            ...
            zombie.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(1);
            ...
            zombie.setCustomName(ChatColor.RED + "The Last King");
        ...
        windslash = Bukkit.getScheduler().runTaskTimer(pl, () -> {
            ...
            undead.getWorld().playSound(lB, Sound.ENTITY_CAT_HISS, SoundCategory.HOSTILE, 1, 1.5f);
        ...
        Cyclone = Bukkit.getScheduler().runTaskTimer(pl, () ->{
            ...
            AreaEffectCloud Spin = undead.getWorld().spawn(lB, AreaEffectCloud.class, spinny ->{
                ...
                spinny.setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE));
                spinny.addCustomEffect(new PotionEffect(LEVITATION, 20, 4, true, true, false), true);
                spinny.setRadius(3);
                spinny.setDuration(20);
                spinny.setDurationOnUse(0);
                spinny.setReapplicationDelay(2);
                spinny.setParticle(Particle.SWEEP_ATTACK);
                spinny.setRadiusPerTick(1/40);
            });
            Trace = 0;
            CycloneTrack = Bukkit.getScheduler().runTaskTimer(pl, () ->{
                if (Trace >6) {CycloneTrack.cancel();}
                Trace = Trace +1;
